...
import com.sidcoparking.activity.Login;
...
import static com.sidcoparking.utils.Util.BUILDING_MASTER;
import static com.sidcoparking.utils.Util.CHECK_VEHICLE;
import static com.sidcoparking.utils.Util.GET_TARIFF;
import static com.sidcoparking.utils.Util.ONLINE_PARKING;
import static com.sidcoparking.utils.Util.PAYMENT_MODE;

public class ParkingOnline extends Fragment implements View.OnClickListener {
    ...
    Spinner SpinBlock, SpinBuilding;
    String BUIDING;
    ...
    String SlotId, Buildingid;

    public ParkingOnline() {
        // Required empty public constructor
    }

    public static ParkingOnline newInstance(String param1, String param2) {
        ParkingOnline fragment = new ParkingOnline();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.parking_online, container, false);
        ...
        SpinBlock = rootView.findViewById(R.id.block_spinner);
        SpinBuilding = rootView.findViewById(R.id.building_spinner);
    ...
    private void SlotSpinner() {

        SpinBlock.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {

            //@Override
            public void onItemSelected(AdapterView<?> parent, View arg1, int arg2, long arg3) {
                String BuildingName = SpinBlock.getSelectedItem().toString();
                SlotId = "";
                Util.Logcat.e("BuildingName::" + BuildingName);

                try {
                    JSONObject resobject = new JSONObject(BUIDING);
                    JSONArray jsonArray = resobject.optJSONArray("_lstbuildingmaster");
                    for (int j = 0; j < jsonArray.length(); j++) {
                        JSONObject object = jsonArray.getJSONObject(j);
                        if (BuildingName.equalsIgnoreCase(object.getString("BuildingName"))) {
                            Buildingid = object.getString("BuildingId");
                            LoadBuidingSpinner(object.getString("BuildingId"));
                            break;
                        }
                    }
                } catch (JSONException e) {
        ...
        SpinBuilding.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            //@Override
            public void onItemSelected(AdapterView<?> parent, View arg1, int arg2, long arg3) {
                String SlotName = SpinBuilding.getSelectedItem().toString();
                // Util.Logcat.e("StrTimeSlab::" + StrTimeSlab);
                try {
                    JSONObject resobject = new JSONObject(BUIDING);
                    JSONArray jsonArray = resobject.optJSONArray("_lstSlotMaster");

                    for (int j = 0; j < jsonArray.length(); j++) {
                        JSONObject object = jsonArray.getJSONObject(j);
                        if (SlotName.equalsIgnoreCase(object.getString("SlotName"))) {
                            SlotId = object.getString("SlotId");
                            Util.Logcat.e("SlotId::" + SlotId);
                            break;
                        }
                    }
                } catch (JSONException e) {
    ...
    private void LoadBuidingSpinner(String BuildingId) {
        // Buildingid=BuildingId;
        Util.Logcat.e("BuildingId:" + BuildingId);

        try {
            JSONObject resobject = new JSONObject(BUIDING);
            JSONArray jsonArray = resobject.optJSONArray("_lstSlotMaster");
            final List<String> SlotName = new ArrayList<>();
            for (int j = 0; j < jsonArray.length(); j++) {
                JSONObject object = jsonArray.getJSONObject(j);
                Util.Logcat.e("SlotName:" + object.getString("SlotName"));
                if (BuildingId.equalsIgnoreCase(object.getString("BuildingId"))) {
                    SlotName.add(object.getString("SlotName"));
                }
            }
                ...
                public void run() {
                    ArrayAdapter<String> spinnerArrayAdapter = new ArrayAdapter<>
                            (getActivity(), R.layout.spinner_textview,
                                    SlotName); //selected item will look like a spinner set from XML
                    spinnerArrayAdapter.setDropDownViewResource(android.R.layout
                            .simple_spinner_dropdown_item);
                    SpinBuilding.setAdapter(spinnerArrayAdapter);
                }
            });
    ...
    private void LoadBlockBuilding(final String StreetId) {

        try {
            JSONObject obj = new JSONObject();
            obj.put("UserId", Util.getData("UserId", getActivity().getApplicationContext()));
            obj.put("StreetId", StreetId);
            obj.put("BuildingId", "0");
            Util.Logcat.e("BUILDIND:::" + obj.toString());
            String data = Util.EncryptURL(obj.toString());
            JSONObject params = new JSONObject();

            params.put("Getrequestresponse", data);
            CallApi.postResponse(getActivity(), params.toString(), BUILDING_MASTER, new VolleyResponseListener() {
                @Override
                ...
                public void onResponse(JSONObject response) {
                    ...
                    try {
                        ...
                        Util.Logcat.e("BUILDIND:::" + resobject.toString());
                        BUIDING = resobject.toString();
                        if (resobject.getString("Status").equalsIgnoreCase("0")) {
                            JSONArray jsonArray = resobject.optJSONArray("_lstbuildingmaster");

                            final List<String> BuildingName = new ArrayList<>();

                            for (int i = 0; i < jsonArray.length(); i++) {

                                JSONObject jsonObject = jsonArray.getJSONObject(i);
                                if (jsonObject.getString("StreetId").equalsIgnoreCase(StreetId)) {
                                    JSONObject savedata = new JSONObject();
                                    savedata.put("BuildingName", jsonObject.getString("BuildingName"));
                                    savedata.put("StreetId", jsonObject.getString("StreetId"));
                                    //      streetarray.put(savedata);
                                    BuildingName.add(jsonObject.getString("BuildingName"));
                                }
                            }
                            getActivity().runOnUiThread(new Runnable() {
                                @Override
                                public void run() {
                                    ArrayAdapter<String> spinnerArrayAdapter = new ArrayAdapter<>
                                            (getActivity(), R.layout.spinner_textview,
                                                    BuildingName); //selected item will look like a spinner set from XML
                                    spinnerArrayAdapter.setDropDownViewResource(android.R.layout
                                            .simple_spinner_dropdown_item);
                                    SpinBlock.setAdapter(spinnerArrayAdapter);
                                }
                            });
    ...
    public void onResume() {
        ...
        Util.saveData("tab", "1", getActivity().getApplicationContext());
    }
                ...
                public void onResponse(JSONObject response) {
                    ...
                    try {
                        ...
                        if (resobject.getString("Status").equalsIgnoreCase("0")) {
                            ...
                            data.put("SlotName", resobject.getString("SlotName"));
                            data.put("SlotId", resobject.getString("SlotId"));
    ...
    private void SaveData() {
       ...
       /* if (booleanvehicle) {
        ...
        String datetime = Util.parkingtime(0);
       ...
       /* boolean isInserted = TransactionDB.insertData(TRANSID, VehicleTypeID, EdVehicleNo.getEditableText().toString(), STREETID,
        ...
        String data = TRANSID + "~" +
                VehicleTypeID + "~" +
                EdVehicleNo.getEditableText().toString() + "~" +
                STREETID + "~" +
                StrHour + "~" +
                EdAmount.getEditableText().toString() + "~" +
                "0" + "~" +
                "0" + "~" +
                "0" + "~" +
                IsFOC + "~" +
                Util.getData("UserId", getActivity().getApplicationContext()) + "~" +
                Entry + "~" +
                Expiry + "~" +
                StrPayment + "~" +
                MobileNumber + "~" +
        ...
        if (SlotId.isEmpty()) {
            alert.build("Select Slot");
        } else if (StrHour.isEmpty()) {
            alert.build("Select Hour");
        } else if (StrPayment.isEmpty()) {
            alert.build("Select Payment Mode");
        } else {
            InsertOnline(data);
        }
    ...
    private void InsertOnline(String TransInfo) {

        try {
            JSONObject obj = new JSONObject();
            obj.put("TerminalId", Util.getData("terminalid", getActivity().getApplicationContext()));
            obj.put("TransactionInfo", TransInfo);
            Util.Logcat.e("SAVE ONLINE:::" + obj.toString());
            String data = Util.EncryptURL(obj.toString());

            JSONObject params = new JSONObject();
            params.put("Getrequestresponse", data);

            CallApi.postResponse(getActivity(), params.toString(), ONLINE_PARKING, new VolleyResponseListener() {
                @Override
                public void onError(String message) {
                ...
                public void onResponse(JSONObject response) {
                    ...
                    try {
                        ...
                        JSONObject resobject = new JSONObject(Util.Decrypt(response.getString("Postresponse")));
                        Util.Logcat.e("SAVE ONLINE:::" + resobject.toString());
                        if (resobject.getString("Status").equalsIgnoreCase("0")) {
    ...
    private void InsertOnlineVerify(String TransInfo, final String printdata) {
                ...
                public void onResponse(JSONObject response) {
                    ...
                    try {
                        ...
                        if (resobject.getString("Status").equalsIgnoreCase("0")) {
                            //JSONArray jsonArray = resobject.optJSONArray("_getAtd");
                            alert.build(resobject.getString("StatusDesc"));
                            MainActivity.printContent = printdata;
                            Util.Logcat.e("PRINT" + printdata);
    ...
    private void PrintReciept() {
        ...
        printvalues.append("\n" + "V.Type     :" + VehicleType);
        printvalues.append("\n" + "Slot     :" + SpinBuilding.getSelectedItem().toString().toUpperCase());
...
//print Data
                    ...
                    if (print == true) {
                        ...
                        InsertOnlineVerify(TransInfo, printvalues.toString());
                ...
                public void onResponse(JSONObject response) {
                    ...
                    try {
                        ...
                        if (resobject.getString("Status").equalsIgnoreCase("0")) {
                            ...
                            Util.saveData("tarifdetails", resobject.toString(), getActivity().getApplicationContext());
                            LoadStreetSpinner();
                            LoadPaymentSpinner();
                            //  Util.saveData("tariffcheck", "1",  getActivity().getApplicationContext());

                            //  UpdateStatus("1");
                            Util.Logcat.e("tarifdetails" + Util.getData("tarifdetails", getActivity().getApplicationContext()));
                        } else if (resobject.getString("Status").equalsIgnoreCase("1")) {
