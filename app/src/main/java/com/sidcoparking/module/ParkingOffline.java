...
public class ParkingOffline extends Fragment implements View.OnClickListener {
     ...
     */
    public static ParkingOffline newInstance(String param1, String param2) {
        ParkingOffline fragment = new ParkingOffline();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.parking_offline, container, false);
    ...
    public void onResume() {
        ...
        Util.saveData("tab", "0",getActivity().getApplicationContext());
    }
