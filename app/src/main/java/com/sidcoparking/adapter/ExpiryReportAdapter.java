...
public class ExpiryReportAdapter extends BaseAdapter {
    ...
    public ExpiryReportAdapter(Activity context, List<Map<String, String>> listCollectionone) {
        activity = context;
    ...
    public View getView(final int position, final View convertView, ViewGroup parent) {
        ...
        if (vi == null) {
            ...
            vi = inflater.inflate(R.layout.expiryreport_adapter, null);
    ...
    public static class ViewHolder {
        ...
        TextView TxtVehicleType, TxtVehicleNo, TxtExpiryTime;
